    ...
    >
      ...
      <motion.div className="titleContainer" variants={variants}>
        <div className="title">
          ...
          <h1>
            {" "}
            <motion.b whileHover={{ color: "#59B4C3" }}>
              {" "}
              Building{" "}
            </motion.b>{" "}
            Future
        ...
        <div className="title">
          <h1>
            ...
            <motion.b whileHover={{ color: "#59B4C3" }}>Code</motion.b> at a
            Time
          </h1>
      ...
      <motion.div className="listContainer" variants={variants}>
        ...
        >
          ...
          <p>
            <b>Frontend:</b> HTML,CSS, ReactJS, ReduxJS, Tailwind, <br />{" "}
            Bootstrap, NextJs{" "}
          </p>
          <p>
          ...
          <p>
            <b>Developer Tools:</b> Git, VSCode, Github
          </p>
        </motion.div>
        <motion.div
          className="box"
        ...
        >
          ...
          <p>
            <b>Relational Database:</b> MySQL, PostgreSQL{" "}
          </p>
          <p>
            <b>Non-Relational Database:</b> MongoDB
          </p>
        </motion.div>
        <motion.div
          className="box"
        ...
        >
          ...
          <p>
            {" "}
            <b>Other Technology:</b> Docker, Kubernetes, OpenAPISpec, Kafka,
            Reddis
          </p>
        </motion.div>
        <motion.div
